...
//		ffmpeg.exe -ss 00:00:01 -i spring.mp4 -vframes 1 bb.jpg
	...
	public static void main(String[] args) {
		// 获取视频信息。
		FetchVideoCover videoInfo = new FetchVideoCover("/usr/local/bin/ffmpeg");
		try {
			videoInfo.getCover("/Users/guopeng/Desktop/imooc.mp4","/Users/guopeng/Desktop/new.jpg");
